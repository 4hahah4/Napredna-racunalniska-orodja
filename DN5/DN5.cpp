...
int main() {
    ...
    // V naslednjih n vrsticah imamo elemente matrike A, zato naredimo  iteracijo, da preberemo in zafilamo matriko A
    ...
    // Sedaj imamo A in b. Lahko napisemo Gauss-Seidel metodo. Najprej inicializiramo vektor resitve T, npr. na 100 stopinj.
    vector<double> T;
